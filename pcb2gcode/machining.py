...
# Grab the setups
from .pcb_inventory import Inventory, Oblong
...
class Machining:
    ...
    def create_tool_rack(self, operation: Operations):
        """
        ...
        for h in self.inventory.holes:
            if (operation & Operations.DRILL_PTH and h.pth) or (operation & Operations.DRILL_NPTH and not h.pth):
